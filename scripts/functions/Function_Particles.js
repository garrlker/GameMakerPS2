...
///			</returns>
// #############################################################################################
function part_type_blend(_ind,_additive)  //ParticleType_Blend
{
    ErrorFunction("part_type_blend()");
}
...
function effect_create_below(_kind,_x,_y,_size,_color) {
	Effect_Create(true, _kind, _x, _y, _size, _color);
}
...
function effect_create_above(_kind,_x,_y,_size,_color) {
	Effect_Create(false, _kind, _x, _y, _size, _color);
}
