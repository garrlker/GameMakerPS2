...
function	Eff_Effect00(_ps, _x, _y, _size, _col)
{
	...
	if ( size == 0 )
	{
		...
		ParticleSystem_Particles_Create_Color(_ps,_x,_y, pt_explosion[1], c_black,1);
	}
	else if ( size == 2 )
	{
		...
		ParticleSystem_Particles_Create_Color(_ps,_x,_y,pt_explosion[5],c_black,1);
	}
	else
	{
		...
		ParticleSystem_Particles_Create_Color(_ps,_x,_y,pt_explosion[3],c_black,1);
	}
}
...
function Eff_Effect09(_ps, _x, _y, _size, _col)
{
	...
	else if ( _size == 2 )
	{
		...
		ParticleSystem_Particles_Create_Color(_ps,_x,_y,pt_cloud[02],_col,1);
	}
	else
	{
