...
yyTimeline.prototype.FindLarger = function(_timeStamp) 
{
	...
	if (_timeStamp > this.Events[this.Events.length - 1])
	{
...
yyTimelineManager.prototype.AddEvent = function (_ind, _timeStamp, _codestr) {
	if ((_ind >= 0) || (_ind < this.Timelines.length))
	{
		...
		var eventIndex = timeline.Events.length;
		timeline.Events[eventIndex].Time = _timeStamp;
		timeline.Events[eventIndex].Event = _codestr;
	}
};
